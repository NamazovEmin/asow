...
public class WagonControllerDictionary {
    public static final String WAGON_1 = "{\"id\":1,\"firstName\":\"Yury\",\"lastName\":\"Petrov\",\"secondName\":\"Stakanych\",\"gender\":\"MALE\",\"birthday\":\"2000-11-22T00:00:00.000+00:00\",\"currentCity\":{\"id\":1,\"name\":\"Moscow\"},\"nickname\":\"iuric\",\"email\":\"y.petrov@mail.com\",\"phone\":\"+7(999)123-4567\",\"followingsNumber\":2,\"followersNumber\":1}";
    public static final String WAGON_2 = "{\"id\":2,\"firstName\":\"Anna\",\"lastName\":\"Smile\",\"secondName\":\"Maria\",\"gender\":\"FEMALE\",\"birthday\":\"2002-01-02T00:00:00.000+00:00\",\"currentCity\":{\"id\":4,\"name\":\"Paris\"},\"nickname\":\"asmile\",\"followingsNumber\":1,\"followersNumber\":1}";
    public static final String WAGON_4 = "{\"id\":4,\"firstName\":\"Petia\",\"lastName\":\"Homo\",\"gender\":\"OTHER\",\"birthday\":\"0001-01-01T00:00:00.000+00:00\",\"currentCity\":{\"id\":2,\"name\":\"Samara\"},\"nickname\":\"phomo\",\"followingsNumber\":0,\"followersNumber\":1}";
    public static final String EXAMPLE_RESPONSE_GET_ALL_OK_200 = "[" + WAGON_1 + "," + WAGON_2 + "," + WAGON_4 + "]";
    public static final String EXAMPLE_RESPONSE_GET_WAGON_OK_200 = WAGON_1;
    public static final String EXAMPLE_RESPONSE_GET_WAGON_NOT_FOUND_ERROR_500 = "{\"errors\":[{\"httpStatusCode\":500,\"frontendCode\":\"businessError\",\"messageToCustomer\":\"Внутренняя бизнес ошибка\",\"meta\":{\"jexceptionMsg\":\"com.example.microservices.users.error.exception.UserNotFoundResponseStatusException{HttpStatus: 404 NOT_FOUND, Reason: Resource User(id: 9999) Not Found}\"}}]}";
